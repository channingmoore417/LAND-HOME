...
import { COMMUNITIES, FEATURES, PRICE_BANDS, BEDS, BATHS, matchHref as buildMatchHref } from "@/lib/buyerMatch";
...
export default function BuyerQuizClient() {
  ...
  const matchHref = () => buildMatchHref(a);
